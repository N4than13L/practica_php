...
<head>
    ...
    <title>Agrega clasificacion curso</title>
...
<body>
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" name="fileinfo" role="form">
        ...
        <h3>Agregar Clasificacion del Curso</h3>
        ...
        <input type="text" name="txtCursoClas" id="txtCursoClas" placeholder="agrega el nombre" value="<?php echo (isset($_GET['id']) ? $row['nombre'] : '') ?>" />
        ...
        <script>
            function guardar() {
                ...
                fetch('../assets/function/clasificacion-curso.php', {
                        method: 'POST',
                        body: data
                    })
            ...
            function borrar(codigo) {
                ...
                fetch('../assets/function/clasificacion-curso-eliminar.php', {
                        method: 'POST',
                        body: data
                    })
                    .then(function(response) {
        ...
        <div id='contenido'>
            <?php
            $sql = "SELECT * FROM curso_clasificacion";
            $result = $mysqli->query($sql) or trigger_error($mysqli->error . " [$sql]");
            $i = 0;
            echo '
      <table>
          ...
          <tr>
              ...
              <a href=clasificacionCurso.php?id=' . $row['id'] . ' >                    
              ' . $row["nombre"] . ' 
               </a>
